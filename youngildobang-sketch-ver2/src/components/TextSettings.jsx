      ...
      <div className="text-option">
        ...
        <div className="text-select">
          ...
          <select name="font" className="text-font"
            ...
            <option value="yeongdeok" id="font-yeongdeok">영덕바다</option>
            <option value="cookierun" id="font-cookierun">쿠키런</option>
            <option value="NanumSquare" id="font-nanumSquare">나눔스퀘어</option>
            <option value="OneMobile" id="font-onemobile">원스토어체</option>
            <option value="SB" id="font-SB">어그로</option>
